      ...
      <div className="relative hidden overflow-hidden border-l border-border bg-sidebar lg:flex">
        ...
        <div className="relative flex w-full flex-col justify-between p-12">
          ...
          <div className="max-w-md">
            <blockquote className="text-lg leading-relaxed tracking-tight text-foreground">
              Validate your startup idea against thousands of benchmarks. Get an investor-grade
              SWOT, market analysis, and readiness score in minutes.
            </blockquote>
          </div>
          <div className="text-xs text-muted-foreground">
