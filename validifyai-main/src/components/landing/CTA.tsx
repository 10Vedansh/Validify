...
export function CTA() {
  return (
    <section className="relative border-b border-border/40 py-20 sm:py-24 overflow-hidden">
      ...
      >
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[400px] w-[400px] rounded-full bg-primary/6 blur-[120px]" />
      </motion.div>
      ...
      <div className="relative mx-auto max-w-6xl px-8">
        ...
        >
          <motion.div
            className="absolute -top-24 -right-24 h-[300px] w-[300px] rounded-full bg-primary/5 blur-[100px]"
